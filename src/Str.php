...
class Str
{
     ...
     * @return boolean
     */
    public static function startsWith(string $start, string $subject)
    {
        return strpos($subject, $start) === 0;
        // return preg_match('/^' . $start . '/', $str);
    }
     ...
     * @return boolean
     */
    public function endsWith(string $end, string $subject)
    {
        return preg_match('/' . $end . '$/', $subject);
    }
